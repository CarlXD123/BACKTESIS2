...
class ClientServicios {
    ...
    static getClientAll(offset, limit, query = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            natio.id nationid, natio."name" nationname
            ...
            left join "Nations" natio on natio.id = e."NationId"
            ...
            where e."id"=${r.get('id')}`, { type: sequelize_1.QueryTypes.SELECT }))[0];
                ...
                datos.push({
                    ...
                    "nacion": {
                        "id": daton.nationid,
                        "name": daton.nationname,
                        "value": daton.nationid,
                        "label": daton.nationname
                    },
                    roles: roles,
                    rolesId: rolesid
                });
    ...
    static updateUser(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const cliente = yield User_1.default.findOne({ where: { id: id } });
