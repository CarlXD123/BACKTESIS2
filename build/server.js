...
const rApilisMatchData_1 = __importDefault(require("./routes/rApilisMatchData"));
const rApilisMatchDataDetail_1 = __importDefault(require("./routes/rApilisMatchDataDetail"));
const rApilisMonitor_1 = __importDefault(require("./routes/rApilisMonitor"));
const rReadCsv_1 = __importDefault(require("./routes/rReadCsv"));
const rProcess_1 = __importDefault(require("./routes/rProcess"));
class Server {
    constructor() {
    ...
    routes() {
        ...
        this.app.use("/api/match", rApilisMatchData_1.default);
        this.app.use("/api/matchdetail", rApilisMatchDataDetail_1.default);
        this.app.use("/api/monitor", rApilisMonitor_1.default);
        this.app.use("/api/dymind", rReadCsv_1.default);
        this.app.use("/api/process", rProcess_1.default);
        // Ruta de prueba
